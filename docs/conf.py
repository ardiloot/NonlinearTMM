...
latex_documents = [
    (master_doc, 'NonlinearTMM.tex', 'NonlinearTMM Documentation',
     'Ardi Loot', 'manual'),
]
...
man_pages = [
    (master_doc, 'nonlineartmm', 'NonlinearTMM Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'NonlinearTMM', 'NonlinearTMM Documentation',
     author, 'NonlinearTMM', 'One line description of project.',
     'Miscellaneous'),
]
