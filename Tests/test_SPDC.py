...
def tmmParams(crystalD, pwrP1, n1, n2):
    ...
    tmm = SecondOrderNLTMM(
        mode="spdc", deltaWlSpdc=deltaWlSpdc, solidAngleSpdc=solidAngleSpdc, deltaThetaSpdc=deltaThetaSpdc
    )
...
def test_SPDCIntensity(tmmParams, betaP1):
    ...
    quantumSpdc = SpdcPowerQuantum(
        tmm.P1.wl,
        tmm.P2.wl,
        betaP1,
        betasP2,
        lambda wl: nF.GetN(wl).real,
        chi2,
        crystalD,
        pwrP1,
        tmm.deltaWlSpdc,
