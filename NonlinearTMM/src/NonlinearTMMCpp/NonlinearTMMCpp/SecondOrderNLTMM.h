...
namespace TMM {
	...
	public:
		...
		NonlinearTMM* GetP2();
		NonlinearTMM* GetGen();
		SweepResultSecondOrderNLTMM* Sweep(TMMParam param, const Eigen::Map<ArrayXd> &valuesP1, const Eigen::Map<ArrayXd> &valuesP2, int outmask = 1, int layerNr = 0, double layerZ = 0.0);
		FieldsZX * GetGenWaveFields2D(const Eigen::Map<ArrayXd>& betasP1, const Eigen::Map<ArrayXd>& betasP2, const Eigen::Map<ArrayXcd>& E0sP1, const Eigen::Map<ArrayXcd>& E0sP2, const Eigen::Map<ArrayXd>& zs, const Eigen::Map<ArrayXd>& xs, WaveDirection dir = TOT);
		pairdd GetPowerFlowsGenForWave(const Eigen::Map<ArrayXd>& betasP1, const Eigen::Map<ArrayXd>& betasP2, const Eigen::Map<ArrayXcd>& E0sP1, const Eigen::Map<ArrayXcd>& E0sP2, int layerNr, double x0, double x1, double z, double Ly, WaveDirection dir);
	};
}